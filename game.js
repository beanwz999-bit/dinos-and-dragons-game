    ...
    try {
        ...
        if (game.state === 'menu') {
            ...
            if (game.menuFlashing) {
                ...
                if (game.menuFlashTicks === 0) { game.fadeDirection = 1; game.fadeAlpha = 0; game.nextState = 'char_select'; game.playerJoined = [true, false, false]; game.playerCount = 1; game.menuFlashing = false; }
            }
...
window.addEventListener('keydown', (e) => {
    ...
    if (game.paused) { // Handle pause menu
        if (e.code === 'ArrowUp') { game.pauseMenuIndex = (game.pauseMenuIndex - 1 + game.pauseMenuOptions.length) % game.pauseMenuOptions.length; }
            ...
            else if (game.pauseMenuIndex === 1) { resetGame(); startGame(game.playerCount); game.state = 'playing'; } // Restart
    ...
    if (game.state === 'menu') {
        if (e.code === 'Enter') { game.menuFlashing = true; game.menuFlashTicks = 60; game.fadeSpeed = 0.05; }
    } else if (game.state === 'char_select') {
        // Dynamic joining
